               ...
               <!-- <td><input type="submit" name="submit" value="Salvar" class="btn btn-padrao btn-shadow btn-rc"/></td>-->
                ...
                if ($_SESSION['nome_perfil'] === 'Orientando') {
                    ...
                    if (!isset($subatividades[0]['data_validacao_sub_atividade'])) {
                        switch ($subatividades[0]['status_sub_atividade']) {
                            case "E":
                                echo "<td><input type='submit' name='submit' value='Validar' class='btn btn-padrao btn-shadow btn-rc'/></td>";
                                echo "<td><input type='submit' name='submit' value='Recusar' class='btn btn-padrao btn-shadow btn-rc'/></td>";
                                break;
                            case "EA":
                                echo "<td><input type='submit' name='submit' value='Validar' class='btn btn-padrao btn-shadow btn-rc'/></td>";
                                echo "<td><input type='submit' name='submit' value='Recusar' class='btn btn-padrao btn-shadow btn-rc'/></td>";
