    ...
    <body>
        ...
        <form method="post" action="<?php echo BASE_URL; ?>validaLogin">
            <div class="div_form ">
                                ...
                                <input class="form-control" name="Login" placeholder="Entre com o login" type="text"><br>
                                <label class="label" for="exampleInputPassword1">Senha</label><br>
                                <input class="form-control" name="exampleInputPassword1" placeholder="Senha" type="password"><br>
