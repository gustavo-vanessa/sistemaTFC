            ...
            <table class="table th td" >
                ...
                <tbody>
                    ...
                    foreach ($atividadesPadroes as $atividadePadrao) {
                        ...
                        echo "<td ><a class = 'btn btn-padrao btn-shadow btn-rc' href = " . BASE_URL . "/atividadePadrao/formAlterar/" . $usuario['id_usuario'] . ">Alterar</td>";
                        echo "<td><a class = 'btn btn-padrao btn-shadow btn-rc' href = " . BASE_URL . "/atividadePadrao/excluir/" . $usuario['id_usuario'] . ">Excluir</td>";
                        echo "</tr> ";
                    }
                    ?>
                </tbody>
